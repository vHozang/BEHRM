...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware(['hrm.auth', 'module.access'])->group(function (): void {
        ...
        Route::get('/attendance/timesheet/overview', [AttendanceController::class, 'timesheetOverview']);
        ...
        Route::get('/attendance/operations/{runId}', [AttendanceController::class, 'operation']);
