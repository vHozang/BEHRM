...
const messages = {
  vi: {
    ...
    dashboard: {
      ...
      aiInsights: 'Gợi ý vận hành',
      confidence: 'Mức tín hiệu',
      ...
      late: 'Đi muộn',
      absent: 'Vắng',
      apiUnavailable: 'API không khả dụng — chưa thể tải dữ liệu.',
  ...
  en: {
    ...
    dashboard: {
      ...
      aiInsights: 'Operational insights',
      confidence: 'Signal',
      ...
      late: 'Late',
      absent: 'Absent',
      apiUnavailable: 'API unavailable — data could not be loaded.',
