...
import { filterEmployeesByDepartment, findEmployeeByCode } from '../src/utils/employeeLookup.js';
import { formatMoneyInput, moneyDigits, parseMoneyInput } from '../src/utils/money.js';
...
const personnelSource = await readFile('src/views/PersonnelDecisions.vue', 'utf8');
