...
const salaryService = await readFile('src/services/salaryService.js', 'utf8');
...
const portal = await readFile('src/views/EmployeePortal.vue', 'utf8');
...
const mobile = await readFile('src/views/mobile/MSalary.vue', 'utf8');
