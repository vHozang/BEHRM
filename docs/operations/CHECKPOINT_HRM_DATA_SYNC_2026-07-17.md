...
- `BE/database/seeders/DemoCoverageSeeder.php`
- `BE/database/seeders/ScaleWorkerSeeder.php`
- `BE/database/seeders/StandardizeAttendanceSeeder.php`
- `BE/database/seeders/StandardizePayrollSeeder.php`
- `BE/database/seeders/DatabaseSeeder.php`
- `BE/app/Http/Controllers/Api/EmployeeController.php`
- `BE/app/Http/Controllers/Api/ContractController.php`
- `BE/app/Support/EmployeeStatus.php`
- `BE/app/Services/AttendanceSummaryService.php`
- `BE/app/Services/PayrollRunService.php`
- `FE/src/services/employeeService.js`
- `FE/src/services/contractService.js`
- Các test feature tương ứng trong `BE/tests/Feature/`.
